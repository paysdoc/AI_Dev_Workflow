/**
 * Production seam for the guardrails startup probe.
 *
...
/**
 * Never throws — a spawn failure (e.g. `bunx` missing) is itself reported as
 * a failed verdict, consistent with the fail-open contract this probe exists
 * to serve.
 *
