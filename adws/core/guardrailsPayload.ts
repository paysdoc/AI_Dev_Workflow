 ...
 * target-repo agent spawns. The deny list is sourced from the
 ...
 * Hooks are added here, at spawn time, because they must
 ...
 * must stay absolute to avoid that leak.
 */
