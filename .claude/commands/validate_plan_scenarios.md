...
You are validating alignment between an implementation plan and BDD scenarios for GitHub issue #$1 (ADW session: $0).

### Step 1: Read the implementation plan

Read the file at `$2`. If the file does not exist, skip directly to the Final Output step with:
- aligned: false
...
- aligned: false
- one mismatch of type "plan_uncovered" noting that no scenario files tagged @adw-$1 were found
