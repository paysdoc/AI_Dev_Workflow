...
│   │   ├── githubCodeHost.ts  # findPullRequestByBranch/isPullRequestApproved/approvePullRequest/mergePullRequest delegate to adws/github/prApi.ts (#796); getDefaultBranch/createPullRequest/setSecret/listMergedPullRequests route through createGhRepoApi (#797)
...
│   │   ├── githubIssueTracker.ts  # fetchLabels/addLabel/applyLabel/ensureLabel/createIssue/updateIssueBody/searchOpenIssues/findOpenUpgradeIssue delegate to adws/github/issueApi.ts + labelManager.ts (#796); listIssues delegates to adws/github/issueListApi.ts (#797)
