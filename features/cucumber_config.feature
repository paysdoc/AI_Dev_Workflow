...
Feature: Cucumber config discovers all feature files and step definitions
  ...
  @adw-1epy28-cucumber-regression @adw-7eqwrp-cucumber-regression @adw-2tlgjj-remove-project-board @regression
  Scenario: Step definition file exists for remove_project_board_status feature
    Given the file "features/step_definitions/removeProjectBoardStatusSteps.ts" exists
